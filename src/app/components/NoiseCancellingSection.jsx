...
export default function NoiseCancellingSection({ containerRef }) {
  ...
  return (
    <div id="noise-cancelling" className="absolute inset-0 flex items-center justify-end pointer-events-none z-10 px-5 sm:px-8 md:pr-16 lg:pr-24">
      <motion.div style={{ opacity, x }} className="max-w-[19rem] sm:max-w-md md:max-w-xl ml-auto">
        ...
        <div className="mt-6 space-y-3">
          <p className="text-sm sm:text-lg text-white/70 flex items-start sm:items-center">
