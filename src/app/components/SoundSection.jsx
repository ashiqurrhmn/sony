...
export default function SoundSection({ containerRef }) {
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-start pointer-events-none z-10 px-5 sm:px-8 md:pl-16 lg:pl-24">
      <motion.div style={{ opacity, x }} className="max-w-[19rem] sm:max-w-md md:max-w-xl">
        ...
        <p className="text-sm sm:text-lg text-white/50 mt-3 sm:mt-4 leading-relaxed">
